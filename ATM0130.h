...
class ATM0130 {
  public:
    ...
    void updateScreen();
    inline void updatePoint(int16_t x, int16_t y, uint16_t color);
    inline void updateBlock_8px(int16_t x, int16_t y, uint16_t block[8][8]);
    inline void updateBlock_16px(int16_t x, int16_t y, uint16_t block[16][16]);
    inline void updateBlock_32px(int16_t x, int16_t y, uint16_t block[32][32]);
